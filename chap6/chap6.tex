...
\label{sec:Results}
\begin{figure*}
\includegraphics[trim=4.4cm 8cm 4.5cm 0cm, width=\textwidth]{images/hk_400walk_5000it_chkpt1_MAP_RV.pdf}
...
\begin{figure*}
\includegraphics[trim=4.4cm 7cm 4.5cm 0cm, width=\textwidth]{images/taueinner_migrate3e+03_Kin7e+00_Kout3e+02_sd931.pdf}
...
\begin{figure}
\includegraphics[width=\columnwidth]{images/plot_good_ones.pdf}
...
\label{sec:stability}
\begin{figure*}
\includegraphics[trim=4.4cm 2cm 4.5cm 0cm, width=\textwidth]{images/stability_plot_histogram}
\caption{
