...
Chapter~\ref{chap:HD155358} presents such a detailed numerical treatment, which builds off the work of  \citet{Robertson2012} that used Equation~\ref{eq:RVsum} to extract the orbital parameters of the HD155358 system, which hosts two Jovian-sized planets near mean motion resonance. 
