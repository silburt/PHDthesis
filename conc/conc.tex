...
\begin{enumerate}
\item Improve \hermes more? The ultimate integrator would be \mercury switching scheme + WHDS as the base integrator. Also, if whds doesn't work out then just keep WHFAST and say an improvement is to have WHDS.
