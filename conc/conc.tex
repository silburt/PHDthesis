...
Instead, the WHDS integrator (Section~\ref{sec:whds}) is likely the optimal choice, since it relies on heliocentric coordinates for integrating bodies and solves the two-body and restricted three-body problems exactly. 
