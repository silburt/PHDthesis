...
In the first part of this thesis we conduct a statistical reconstruction of the radius and period distributions for \kep planets. 
...
In particular, \hermes is designed for simulating planetary systems embedded in planetesimal disks. 
\hermes is compared to other popular integrators, and we find \hermes to be a great balance of speed and accuracy.
...
Finally, the HD155358 system is investigated using previously collected radial velocity data. 
...
In addition, constraints are placed on the formation history of HD155358, and we find that our best-fit parameters are longterm stable. 
