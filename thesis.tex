...
Since the launch of the \textit{Kepler Space Telescope}, scientists have finally had an opportunity to study planetary systems outside the Solar System and test planetary theories against observations.
Thousands of exoplanets have been detected by a variety of methods, and collective properties of exoplanetary systems are emerging. 
...
The first part of this thesis conducts a statistical reconstruction of the radius and period distributions for \kep planets. 
...
In particular, 27 \kep systems near 2:1 MMR are analyzed to determine whether tides alone can transport \kep planets from exact MMR to their observed locations.
...
\hermes is specifically designed for planets in planetesimal disks, and includes an adaptive routine for optimizing the close encounter boundary to help maintain accuracy whilst close encounters are occurring.
...
Here we find that a trained machine is capable of accurately classifying longterm planet stability, and is orders of magnitude faster than brute-force N-body integration. 
 
Finally, the planetary system HD155358, which contains two Jovian-sized planets near 2:1 MMR, is investigated using previously collected radial velocity data. 
...
In addition, constraints are placed on the formation history of HD155358, and our best-fit parameters land firmly in stable regions of parameter space. 
